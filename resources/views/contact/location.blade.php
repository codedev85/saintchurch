        ...
        <div class="main_row">
                ...
                <div class="header_hero__text_box">
                    <h1 class="header_hero__main_text">
                        FIND A SAINT COMMUNITY <br>
                        CHURCH AROUND YOU&nbsp;.&nbsp;.&nbsp;.
                    </h1>
                    <p class="header_hero__sub_text">
                        Heralding the lordshipLof the Word,<br> Demonstrating the Influence of the Spirit
                    </p>
                </div>
            ...
            <div class="location__wrapper_one">
                ...
                <div class="individaul_location_container">
                    ...
                    <div class="pin_container">
                        <img class="pin" src="resource/images/pin.svg" alt="">
                    </div>
                    <div class="individual_location_content">

                        <div>
                            <h3 class="individual_location_content__title">
                                <h3>{{$contact_location[0]->name }}  - <span> {{$contact_location[0]->states }} </span>  </h3>

                            </h3>
                            <p class="individual_location_content__text">
                               {{$contact_location[0]->description}} - {{$contact_location[0]->phone_number}}
                            </p>
                        </div>
            ...
            <div class="location__wrapper_two">
                ...
                <div class="individaul_location_container">
                    ...
                    <div class="individual_location_content">
                        ...
                        <div>
                            <h3 class="individual_location_content__title">
                                    <h3>{{$contact_location[2]->name }} - <span> {{$contact_location[1]->states }} </span>  </h3>
                            </h3>
                            <p class="individual_location_content__text">
                                    {{$contact_location[1]->description}}  - {{$contact_location[1]->phone_number}}
                ...
                <div class="individaul_location_container">
                    ...
                    <div class="individual_location_content">
                        ...
                        <div>
                            <h3 class="individual_location_content__title">
                                    <h3>{{$contact_location[2]->name }} - <span> {{$contact_location[2]->states }} </span>  </h3>
                            </h3>
                            <p class="individual_location_content__text">
                                    {{$contact_location[2]->description}} - {{$contact_location[2]->phone_number}}
                            </p>
                        </div>
    ...
    <section class="home__programs_section">
            ...
            <div class="home_programs_container main_row">
                ...
                <div class="home_programs__item home_programs__item--img">
                    <img class="home_programs__img" src="resource/images/So+great+salvation+6a.png" alt="">
                </div>
