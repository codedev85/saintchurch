...
<body>
    ...
    <section>
        <div class="main_row contact_section_container">
            ...
            <p class="contact__details_text">
                <strong>phone:</strong> {{$location[0]->phone_number}}
            </p>
            <p class="contact__details_text">
                <strong> ADDRESS: </strong>{{$location[0]->description}}

            </p>

            <div class="contact__btn_container">
            <a href="{{url('/locations/')}}" class="home__btn home__btn--red_stroked">LOCATE OUR BRANCHES</a>
    ...
    <section class="home__branch_section">
        ...
        <div class="home_branches main_row">
            ...
            <div class="home_branches__flex_container">
                ...
                <div class="home_branches__flex_item">
                <a style="width: 100%;" href="{{url('/locations/')}}" class="home__btn home__btn--red_stroked home__btn--red_smaller">
            ...
            <div class="contact_modal__content">
                <div class="contact_modal__header">
                    ...
                    <div class="modal_contact__close">
                        <img src="resource/images/close_btn.svg" width="20px" alt="">
                    </div>
                </div>
                ...
                <div class="contact_modal__body">
                    ...
                    <form action="{{url('/contact_us/store/')}}" name="church_form" method="POST" >
                        @csrf
                    ...
                    <div class="contact_modal__input_container">
                        ...
                        <input type="text" required name="first_name" id="first_name" class="contact_modal__input" placeholder="First Name">
                        <br>
                        <input type="text" required name="last_name" id="last_name" class="contact_modal__input" placeholder="Last Name">
