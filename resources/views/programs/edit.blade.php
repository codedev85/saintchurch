...
<section class="container">
    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <p class="text__description">Edit Program</p>
            </div>


            <div class="form__container">
            <form action="{{url('program/update/'.$program_edit->id)}}" method="POST" enctype="multipart/form-data">
             @csrf

                <div class="data__field">

                    <div class="data__field--1">
                    <input type="text" name="name" value="{{$program_edit->title}}" class="title__box">
                    </div>
                    <div class="data__field--1">
  ...
  {{-- <img src="{{url('storage/'.$program_edit->img_path1)}}" alt="" class="advert-img img-fluid mb-3 shadow-in"> --}}
                ...
                <img src="{{url('storage/'.$program_edit->img_path1)}}" name="img_path1" width="200" height="400" alt="" class="bg__image">
                    <button class="add__photo"><span>ADD PHOTO</span></button>

                </div>
                <div class="featured__image">

                        <img src="{{url('storage/'.$program_edit->img_path2)}}" name="img_path2" width="200" height="400" alt="" class="bg__image">
