    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                <div>
                        <p class="text__description">Media Update</p>
                </div>
                <div class="form__header--list1">
                    ...
                    <button id="" class=""><span class=""><a href="{{url('/media/create/')}}"> Add To Media </a></span></button>
                    </P>
                </div>
            ...
            <div class="form__container">
                ...
                <div class="table__container">
                    ...
                    @foreach($media as $med)
                       <tr class="table__row">
                       <td class="table__data">{{$med->id}}</td>
                       <td class="table__data">{{$med->created_at}}</td>
                       <td class="table__data">{{$med->name}}</td>
                       <td class="table__data"><a href="{{url('/media/edit/'.$med->id)}}"> EDIT</a>|
                        <form action="{{ url('/media/destroy/'.$med->id) }}" method="post">
