    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <p class="text__description">Add Partners</p>
            </div>

@include('flash.flash-message')

            <div class="form__container">
            <form action="{{url('/partnership/store/')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="data__field">
                      ...
                      <div class="data__field--1">
                            <input type="text" placeholder="Account Name" name="acc_name" class="title__box">
                   </div>
                      <div class="data__field--1">
                            <input type="number" placeholder="Account Number" name="acc1" class="title__box">
                   </div>
                   <div class="data__field--1">
                        <input type="number" placeholder="Account Number" name="acc2" class="title__box">
                    </div>
                      <div class="data__field--1">
                            <input type="file" name="img_path1" class="title__box">
                      </div>
                      {{-- <div class="data__field--1">
                        <input type="file" name="img_path2" class="title__box">
                      </div> --}}
