    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <p class="text__description">Add Category</p>
            </div>


            <div class="form__container">
            <form action="{{url('/lastest_release_category/store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="data__field">
                       ...
                       <div class="data__field--1">
                                ...
                                <input type="text"  name="name" class="title__box">
