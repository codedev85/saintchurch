...
<body>
        ...
        <div class="main_row">
            <div class="program__main">
                ...
                <div class="program__img_container">
                    {{-- <img src="resource/images/events.png" alt=""> --}}
                    <img src="{{url('storage/'.$program->img_path1)}}"alt="" >
                </div>

                <div class="program__main_text_container">
                    <div class="program__main_inner_txt_container">
                        <h3 class="program_main__title">
                            <img src="resource/images/tent.svg" width="24px" alt="">
                            {{$program->title}}</h3>
    ...
    <section>
        <div class="main_row program_event_outer_cont">
            {{-- <div class="program__time_container">
                ...
                <div class="program__time" style="width:1000px";>
                    <div class="program__time_content">
                        <div class="program_red_strip">
                        </div>
                        <h1 id="time"class="time__txt time__txt--minutes">
        ...
        <div class="shadow_box">
            <img src="resource/images/shadow.jpg" alt="" class="shadow_img_box">
        </div>
    </section>
                                ...
                                <div class="program_row_container">
                                    ...
                                    <div class="program_upcoming__inner_container">
                                        <p class="program_upcoming__text_content">
                                            {{ str_limit($program->description, $limit = 150, $end = '...') }}
                                        </p>
                                        <a href="" class="program_upcoming__btn">
                                            <img src="resource/images/read_more_btn.png" alt="">
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="home_branches main_row">
                ...
                <div class="home_branches__flex_container">
                    ...
                    <div class="home_branches__flex_item">
                        ...
                        <p class="home_branches__text">{{$location[1]->description}} </p>
                    </div>
                    <div class="home_branches__flex_item">
                        <div class="home_branches__name_container">
                            <img src="resource/images/MAP_HANDLE.svg" class="home_branches__location_img" alt="">
    ...
    <script src="resource/js/program.js"></script>
    {{-- <script>
