    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                <div>
                        <p class="text__description">Partnership Update</p>
                </div>
                <div class="form__header--list1">
                    ...
                    <a href="{{url('/partnership/create/')}}">
                        <button id="" class=""><span class="">Add To Partnership </span></button>
                        </a>
            ...
            <div class="form__container">
              ...
              @foreach($partnerships as $partnership)
                       <tr class="table__row">
                       <td class="table__data">{{$partnership->id}}</td>
                       <td class="table__data">{{date('Y-m-d',strtotime($partnership->created_at))}}</td>
                       <td class="table__data">{{$partnership->name}}</td>
                       <td class="table__data"><a href="{{url('/partnership/edit/'.$partnership->id)}}">EDIT</a> |
                        <form action="{{ url('/partnership/destroy/'.$partnership->id) }}" method="post">
                        ...
                        {{-- <a href="{{url('/partnership/destroy/'.$partnership->id)}}">DELETE</a></td> --}}
                    </tr>
             @endforeach
