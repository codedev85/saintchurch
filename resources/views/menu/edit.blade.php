        ...
        <div class="center__Container">
            <div class="form__header--list">
                <p class="form__header--sub">
                    <img src="images/right-arrow-forward.svg" alt="" class="back__arrow"><span><a href="{{url('/menu/show')}}">Back</a></span>
                </p>
                <p class="text__description">Edit Link</p>
            </div>


            <div class="form__container">

                       <div class="edit__home--container">

                            <form action="{{url('/menu/update/'.$find_menu->id)}}" method="post" enctype="multipart/form-data">
                                @csrf

                    <div class="data__field--1">
                    <input type="text" name="name" value="{{$find_menu->name}}" class="title__box">
                    </div>
