    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <p class="text__description">Add Banner</p>
            </div>


            <div class="form__container">
            <form action="{{url('/home/banner/store/')}}" method="POST" enctype="multipart/form-data">
...
@csrf
                <div class="data__field">
                       ...
                       <div class="data__field--1">
                                ...
                                <input type="file" placeholder="Create Banner" name="banner" class="title__box">
