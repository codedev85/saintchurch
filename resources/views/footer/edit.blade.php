...
<section class="container">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                <p class="form__header--sub">
                    <img src="images/right-arrow-forward.svg" alt="" class="back__arrow"><span><a href="{{url('/footer/show')}}">Back</a></span>
                </p>
            ...
            <div class="form__container">
                ...
                <form action="{{url('/footer/update/'.$find_footer->id)}}" method="post" enctype="multipart/form-data">
                 @csrf

                    <div class="data__field--1">
                    <input type="text" name="name" value="{{$find_footer->name}}" class="title__box">
                    </div>
                    <div class="data__field--1">

                        <textarea class="textarea__box" name="desc" rows="4" cols="50">
                            {{$find_footer->description}}
                        </textarea>
  ...
  {{-- <img src="{{url('storage/'.$program_edit->img_path1)}}" alt="" class="advert-img img-fluid mb-3 shadow-in"> --}}
               @if($find_footer->img_path1)
                <img src="{{url('storage/'.$find_footer->img_path1)}}" width="200" height="400" alt="" class="bg__image">
                ...
                <div class="featured__image">
                @if($find_footer->img_path1)
                        <img src="{{url('storage/'.$find_footer->img_path2)}}" width="200" height="400" alt="" class="bg__image">
