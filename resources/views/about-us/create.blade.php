    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <p class="text__description">Contact Us</p>
            </div>


            <div class="form__container">
            <form action="{{url('/about_us/store/')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="data__field">
                       ...
                       <div class="data__field--1">
                                ...
                                <input type="text" placeholder="Address" name="address" class="title__box" required>

                       </div>
                       <div class="data__field--1">

                        <input type="text" placeholder="Title" name="name" class="title__box" required>

               </div>
                       <div class="data__field--1">

                        <input type="number" placeholder="Number" name="number" class="title__box" required>
                     ...
                     <div class="data__field--1">
                      ...
                      <div class="data__field--1">
                       ...
                       <div class="data__field--1">
                        ...
                        <textarea name="desc">Details</textarea>
