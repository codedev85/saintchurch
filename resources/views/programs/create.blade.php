    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <p class="text__description">Add Program</p>
            </div>
...
@csrf
                <div class="data__field">
                       ...
                       <div class="data__field--1">
                                ...
                                <input type="text" placeholder="Title" name="title" class="title__box">
                      ...
                      <div class="data__field--1">
                            ...
                            <input type="date"  name="event_date" class="title__box">

                   </div>
                   <div class="data__field--1">

                        <input type="time"  name="event_time" class="title__box">
