    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <p class="text__description">Edit Account Name</p>
            </div>


            <div class="form__container">
            <form action="{{url('/user/update/'.$find_user->id)}}" method="post">
                ...
                <div class="data__field">
                       ...
                       <input type="text" name="name" value="{{$find_user->name}}"class="title__box">
