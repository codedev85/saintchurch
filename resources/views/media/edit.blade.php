...
<section class="container">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                <p class="form__header--sub">
                    <img src="images/right-arrow-forward.svg" alt="" class="back__arrow"><span><a href="{{url('/media/show')}}">Back</a></span>
                </p>
                <p class="text__description">Edit Media</p>
            </div>


            <div class="form__container">
                <div class="data__field">
                <form action="{{url('/media/update/'.$find_media->id)}}" method="post" enctype="multipart/form-data">
                 @csrf

                    <div class="data__field--1">
                    <input type="text" name="name" value="{{$find_media->name}}" class="title__box">
                    </div>
                    <div class="data__field--1">

                        <textarea class="textarea__box" name="desc" rows="4" cols="50">
                            {{$find_media->description}}
                        </textarea>
  ...
  {{-- <img src="{{url('storage/'.$program_edit->img_path1)}}" alt="" class="advert-img img-fluid mb-3 shadow-in"> --}}
                ...
                <img src="{{url('storage/'.$find_media->img_path1)}}" width="200" height="400" alt="" class="bg__image">
                ...
                <div class="featured__image">
                        ...
                        {{-- <img src="{{url('storage/'.$find_media->img_path2)}}" width="200" height="400" alt="" class="bg__image"> --}}
