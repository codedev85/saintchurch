...
<body>
    ...
    <section style="position: relative">
        <div class="partner_content_container main_row">
            ...
            <img src="{{url('storage/'.$partners[0]->img_path1)}}" >
                {{-- <img src="resource/images/partner_img.png" alt=""> --}}
            </div>
            ...
            <div class="partner_text_content">
                ...
                <p class="partnership_account--details">
                    Account Name: {{$partners[0]->acc_name}}
                </p>
                <p class="partnership_account--details">
                    Account No: {{$partners[0]->acc1}} (Zenith Bank)
                </p>
                <p class="partnership_account--details">
                    Account N0: {{$partners[0]->acc2}} (UBA)
                </p>
        ...
        <img src="resource/images/robo.svg" class="partner__robo_first" alt="">
        <img src="resource/images/robo.svg" class="partner__robo_second" alt="">
