        ...
        <div class="main_row">
                ...
                <div class="header_hero__text_box">
                    <h1 class="header_hero__main_text">
                        ABOUT SAINT COMMUNITY CHURCH&nbsp;.&nbsp;.&nbsp;.
                    </h1>
                    <p class="header_hero__sub_text">
                        Heralding the Lordship of the Word,<br> Demonstrating the Influence of the Spirit
                    </p>
                </div>
            ...
            <div class="home_info_link__container main_row">
                <div class="home_info__box_container">
                    <div class="home_info__box">
                        ...
                        <p class="home_info__write-up about_us_write_up">
                               {{$about_us[0]->description}}
                                ...
                                Location - {{$location[0]->description}} - {{$location[0]->states}}<br>
                                Phone Number: {{$location[0]->phone_number}}
                            </p>
                    ...
                    <div class="home_info__box home_info__box_two">
                        ...
                        <img src="{{url('storage/'.$about_us[0]->img_path1)}}"
                        srcset=""
                        sizes=""
                        alt="">
