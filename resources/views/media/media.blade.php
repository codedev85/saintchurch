...
{{$about_us[0]->description}}
                ...
                <p class="media_contact_text">{{$about_us[0]->name}}</p>
                </div>
            ...
            <div class="media_contact_info">
                ...
                <div class="media_text_group media_text_group--space">
                    ...
                    <p class="media_contact_text">{{$about_us[0]->number}}</p>
                </div>
                ...
                <div class="media_text_group">
                    ...
                    <p class="media_contact_text">
                        <a href="{{$about_us[0]->email}}">{{$about_us[0]->email}}</a>
                    </p>
                ...
                <div class="media_text_group">
                    ...
                    <p class="media_contact_text">
                        <a href="" target="_blank">{{$about_us[0]->website}}</a>
                    </p>

                </div>

                <div class="media_living_word_container">
                    <img src="resource/images/living-word.png" height="146px" width="274px" alt="" class="media_living_word_img">
                </div>
    ...
    <section class="media_slider__section">
        ...
        <div class="button button_left previous" onclick="shiftLeft()">
            <img src="resource/images/arrow-point-to-left.svg" alt="">
        </div>
        ...
        <div class="container">
            ...
            <div class="cards-wrapper">
                ...
                <ul class="cards__container">
                    @foreach($find_media as $media_image)
                    <li class="box" style="background-color:red">
                        <img src="{{url('storage/'.$media_image->img_path1)}}" >
                        {{-- <img src="resource/images/Jesus+reads+Psalm+23.png" alt=""> --}}
                    </li>
                    @endforeach

                     {{-- <li class="box">
                            <img src="{{url('storage/'.$find_media[2]->img_path2)}}" >
                        <img src="resource/images/you+can+have+what+you+say.png" alt="">
                    </li>
                    <li class="box">
                            <img src="{{url('storage/'.$find_media[2]->img_path3)}}" >
                        <img src="resource/images/what+God+cannot+change+about+you+.png" alt="">
                    </li>
                    <li class="box">
                            <img src="{{url('storage/'.$find_media[2]->img_path4)}}" >
                        <img src="resource/images/At+the+Apostles+feet.png" alt="">
                    </li> --}}
                   {{-- <li class="box">
                            <img src="{{url('storage/'.$find_media[2]->img_path5)}}" >
                        <img src="resource/images/paise+and+singing.png" alt="">
                    </li>
                    <li class="box box--hide">
                            <img src="{{url('storage/'.$find_media[2]->img_path1)}}" >
                        <img src="resource/images/At+the+Apostles+feet.png" alt="">
                    </li>
                    <li class="box box--hide">
                        <img src="resource/images/you+can+have+what+you+say.png" alt="">
 ...
 @endforeach
    ...
    <script src="resource/js/media_slider.js"></script>
