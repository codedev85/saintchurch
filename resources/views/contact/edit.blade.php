...
<section class="container">
    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                ...
                <p class="text__description">Edit Contact</p>
            </div>


            <div class="form__container">
                <div class="data__field">
                <form action="{{url('/contact_us/update/'.$find_contact->id)}}" method="post" enctype="multipart/form-data">
                 @csrf

                    <div class="data__field--1">
                    <input type="text" name="name" value="{{$find_contact->name}}" class="title__box">
                    </div>


                     <div class="data__field--1">

                                <input type="number" placeholder="Phone Number" name="phone_number" value="{{$find_contact->phone_number}}" class="title__box">

                    </div>

                    <div class="data__field--1">

                            <input type="text" placeholder="Phone Number" name="location" value="{{$find_contact->location}}" class="title__box" disabled>

                </div>

                    <div class="data__field--1">
                        <input type="email" name="email" value="{{$find_contact->email}}" class="title__box">
                        </div>
                    <div class="data__field--1">

                        <textarea class="textarea__box" name="desc" rows="4" cols="50">
                            {{$find_contact->description}}
                        </textarea>
  ...
  {{-- <img src="{{url('storage/'.$program_edit->img_path1)}}" alt="" class="advert-img img-fluid mb-3 shadow-in"> --}}
               @if($find_contact->img_path1)
                <img src="{{url('storage/'.$find_contact->img_path1)}}" width="200" height="400" alt="" class="bg__image">
