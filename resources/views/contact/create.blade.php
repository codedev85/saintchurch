...
<section class="container">
    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            ...
            <form action="{{url('/contact_us/store/')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="data__field">
                       ...
                       <div class="data__field--1">
                                ...
                                <input type="text" placeholder="Church Name" name="name" class="title__box">

                       </div>
                       <div class="data__field--1">

                            <input type="email" placeholder="Email" name="email" class="title__box">

                         </div>

                        <div class="data__field--1">

                                <input type="number" placeholder="Phone Number" name="phone_number" class="title__box">
