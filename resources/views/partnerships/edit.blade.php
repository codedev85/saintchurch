...
<section class="container">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                <p class="form__header--sub">
                    <img src="images/right-arrow-forward.svg" alt="" class="back__arrow"><span><a href="{{url('/partnership/show')}}">Back</a></span>
                </p>
                <p class="text__description">Edit Banner</p>
            </div>


            <div class="form__container">
                <div class="data__field">
                <form action="{{url('/partnership/update/'.$find_partner->id)}}" method="post" enctype="multipart/form-data">
                 @csrf

                    <div class="data__field--1">
                    <input type="text" name="name" value="{{$find_partner->name}}" class="title__box">
                    </div>
                    <div class="data__field--1">

                        <textarea class="textarea__box" name="desc" rows="4" cols="50">
                            {{$find_partner->description}}
                        </textarea>

                    </div>
                    <div class="data__field--1">
                    <input type="text" value="{{$find_partner->acc_name}}" name="acc_name" class="title__box">
                   </div>
                      <div class="data__field--1">
                            <input type="number" value="{{$find_partner->acc1}}" name="acc1" class="title__box">
                   </div>
                   <div class="data__field--1">
                        <input type="number" value="{{$find_partner->acc2}}" name="acc2" class="title__box">
                    </div>
                    <div class="data__field--1">
  ...
  {{-- <img src="{{url('storage/'.$program_edit->img_path1)}}" alt="" class="advert-img img-fluid mb-3 shadow-in"> --}}
                ...
                <img src="{{url('storage/'.$find_partner->img_path1)}}" width="200" height="400" alt="" class="bg__image">
                ...
                {{-- <div class="featured__image">
                        ...
                        <img src="{{url('storage/'.$find_partner->img_path2)}}" width="200" height="400" alt="" class="bg__image">
