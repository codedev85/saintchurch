    ...
    <div class="mainContainer">
        ...
        <div class="center__Container">
            <div class="form__header--list">
                <div>
                        <p class="text__description">Footer Update</p>
                </div>
                <div class="form__header--list1">
                    ...
                    <a href="{{url('/footer/create/')}}">
                        <button id="" class=""><span class="">Add To Footer </span></button>
                        </a>
            ...
            <div class="form__container">
                ...
                <div class="table__container">
                 ...
                 @foreach($footers as $footer)
                       <tr class="table__row">
                       <td class="table__data">{{$footer->id}}</td>
                       <td class="table__data">{{$footer->created_at}}</td>
                       <td class="table__data">{{$footer->name}}</td>
                       <td class="table__data"><a href="{{url('/footer/edit/'.$footer->id)}}">EDIT</a> |
                        <form action="{{ url('/footer/destroy/'.$footer->id) }}" method="post">
